...
Las skills son los contratos de comportamiento y tienen prioridad. Consulta los archivos auxiliares
que ellas indiquen dentro de `Skills/` y `docs/` solo cuando sean relevantes para la tarea actual.
